...
from app.schemas.ai import ContextualExampleRequest, ContextualExampleResponse
from datetime import datetime, timedelta, timezone

router = APIRouter(prefix="/generate", tags=["🤖 AI 생성 (Generation)"])

@router.post("/contextual", summary="맥락 기반 데이터 생성", response_model=ContextualExampleResponse)
